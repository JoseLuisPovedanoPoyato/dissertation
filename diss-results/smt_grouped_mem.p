...
plot "kubernetes/grouped_mem_file_100_10_10" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_100_10_10" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_100_10_10" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_100_10_60" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_100_10_60" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_100_10_60" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_200_10_10" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_200_10_10" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_200_10_10" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_200_10_60" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_200_10_60" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_200_10_60" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_400_10_10" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_400_10_10" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_400_10_10" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_400_10_60" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_400_10_60" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_400_10_60" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_600_10_10" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_600_10_10" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_600_10_10" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_600_10_60" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_600_10_60" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_600_10_60" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_800_10_10" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_800_10_10" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_800_10_10" using 2:xtic(1) title "Linkerd"
...
set ylabel "Memory Used (Bytes)"
set xtics rotate by -45
plot "kubernetes/grouped_mem_file_800_10_60" using 2:xtic(1) title "Kubernetes", "istio/grouped_mem_file_800_10_60" using 2:xtic(1) title "Istio", "linkerd/grouped_mem_file_800_10_60" using 2:xtic(1) title "Linkerd"

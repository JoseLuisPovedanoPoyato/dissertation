...
plot "kubernetes/memory_100_10_10" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_100_10_10" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_100_10_10" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_100_10_60" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_100_10_60" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_100_10_60" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_200_10_10" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_200_10_10" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_200_10_10" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_200_10_60" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_200_10_60" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_200_10_60" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_400_10_10" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_400_10_10" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_400_10_10" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_400_10_60" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_400_10_60" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_400_10_60" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_600_10_10" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_600_10_10" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_600_10_10" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_600_10_60" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_600_10_60" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_600_10_60" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_800_10_10" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_800_10_10" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_800_10_10" using ($1):($2/(1024 * 1024)) title "Linkerd"
...
set xlabel "Time (Since sending first packet) (s)"
set ylabel "Memory Used (MegaBytes)"
plot "kubernetes/memory_800_10_60" using ($1):($2/(1024 * 1024)) title "Kubernetes", "istio/memory_800_10_60" using ($1):($2/(1024 * 1024)) title "Istio", "linkerd/memory_800_10_60" using ($1):($2/(1024 * 1024)) title "Linkerd"

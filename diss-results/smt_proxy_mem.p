...
set title "SMTs Data Plane Usage per Proxy - 100 Users, 10 Microservices"
...
plot "istio/mem_data_plane_by_proxy_100_3_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_100_3_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 100 Users, 20 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 100 Users, 40 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 100 Users, 60 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_100_3_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_100_3_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 100 Users, 80 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 200 Users, 10 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_200_3_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_200_3_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 200 Users, 20 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 200 Users, 40 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 200 Users, 60 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_200_3_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_200_3_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 200 Users, 80 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 400 Users, 10 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_400_3_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_400_3_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 400 Users, 20 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 400 Users, 40 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 400 Users, 60 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_400_3_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_400_3_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 400 Users, 80 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 600 Users, 10 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_600_3_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_600_3_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 600 Users, 20 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 600 Users, 40 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 600 Users, 60 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_600_3_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_600_3_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 600 Users, 80 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 800 Users, 10 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_800_3_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_800_3_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 800 Users, 20 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 800 Users, 40 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
set title "SMTs Data Plane Usage per Proxy - 800 Users, 60 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"
...
plot "istio/mem_data_plane_by_proxy_800_3_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_800_3_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
set title "SMTs Data Plane Usage per Proxy - 800 Users, 80 Microservices"
set style histogram cluster gap 2
set size ratio 0.75 
set grid
set xlabel "Service Mesh"

...
plot "istio/mem_data_plane_by_proxy_100_10_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_100_10_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_100_10_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_100_10_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_200_10_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_200_10_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_200_10_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_200_10_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_400_10_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_400_10_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_400_10_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_400_10_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_600_10_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_600_10_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_600_10_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_600_10_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_800_10_10" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_800_10_10" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"
...
plot "istio/mem_data_plane_by_proxy_800_10_60" using ($0/$0):2:xtic("Istio") title "Istio", "linkerd/mem_data_plane_by_proxy_800_10_60" using ($0/$0 + 1):2:xtic("Linkerd") title "Linkerd"

...
num_folders=$(find ../graphs-consul/ -maxdepth 1 -type d | wc -l)
new_folder_num=$((num_folders + 1))
new_folder_name="../graphs-consul/run_$new_folder_num"
...
cp consul.zip "$new_folder_name"/consul.zip
...
cp consul/*.png ./"$new_folder_name"/consul/

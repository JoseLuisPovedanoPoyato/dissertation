...
set output "kubernetes_latency_3_cross_comp_40.png"
set title "Kubernetes - Latency Comparison 3 RPUs, 40 and 80 Microservices"
set size ratio 0.75 
set grid
...
set datafile separator ','
set terminal png size 700 
set output "kubernetes_latency_5_cross_comp_40.png"
set title "Kubernetes - Latency Comparison 5 RPUs, 40 and 80 Microservices"
set size ratio 0.75 
set grid
set xlabel "Percentage Served (%)"
set ylabel "Response Time (ms)"
...
set datafile separator ','
set terminal png size 700 
set output "kubernetes_latency_10_cross_comp_40.png"
set title "Kubernetes - Latency Comparison 10 RPUs, 40 and 80 Microservices"
set size ratio 0.75 
set grid
set xlabel "Percentage Served (%)"
set ylabel "Response Time (ms)"
